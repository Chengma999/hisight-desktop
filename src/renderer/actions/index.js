...
export const updateOpeningstijden = createAction('overige/updateOpeningstijden')
export const deleteOpeningstijden = createAction('overige/deleteOpeningstijden')

...
function MenulijstAddForm({ menulijsts, addMenulijst }) {
  ...
  const handleSubmit = async (event) => {
    ...
    const index = menulijsts.findIndex(
  ...
  return (
    <div style={{ margin: "auto auto", width: "80%" }}>
      <Divider orientation="left">Menulijst</Divider>
...
export default MenulijstAddForm;

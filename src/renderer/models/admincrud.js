...
export default {
  ...
  effects: {
    *update({ payload }, { call, put }) {
      const {id}=payload
      try {
        const {data} = yield call(axios.post, `${target}/api/admincrud/update`,payload);
    ...
    *add({ payload }, { call, put }) {
      const {id} = payload
      try {
        const {data} = yield call(axios.post, `${target}/api/admincrud/add`,payload);
    ...
    *delete({ payload }, { call, put }) {
      const {id} = payload
      try {
        const {data} = yield call(axios.post, `${target}/api/admincrud/delete`,payload);
    ...
    *ordersFetch({ payload }, { call, put }) {
      try {
        ...
        const {data} = yield call(axios.get, `${target}/api/admincrud/ordersfetch`);
    ...
    *orderPrint({ payload }, { call, put }) {
      try {
        ...
        const {data} = yield call(axios.post, `${target}/api/admincrud/orderprint`,payload);
    ...
    *sms_send({ payload }, { call, put }) {
      ...
      try {
        const {data} = yield call(axios.post, `${target}/api/admincrud/sms_send`,payload);
